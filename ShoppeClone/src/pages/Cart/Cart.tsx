      ...
      setExtendedPurchases((prev) => {
        ...
        return (
          purchasesInCart?.map((purchase) => {
            const isChosenPurchaseFromLocation = chosenPurchaseFromLocation === purchase._id
            return {
              ...purchase,
              disable: false,
      ...
      <div className='container'>
        {extendedPurchases.length > 0 ? (
          ...
          <div className='text-center'>
            <img src={noproduct} alt='no-purchase' className='mx-auto w-24 h-24 object-cover' />
            <div className='text-gray-500 font-bold text-center my-5'>chưa có sản phẩm</div>
            <Link
              to={path.home}
              className='px-12 py-3 bg-orange hover:bg-orange/90 transition-all text-white rounded-sm'
            >
              Mua ngay
            </Link>
          </div>
